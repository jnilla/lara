...
// JHTML::script("media/lib_jnillacomponentframework/js/site-form.js");
...
if(!empty($menuItem)){
	...
	$pageHeading = JText::_("COM_{$componentNameInUpperCase}_PAGETITLE_{$currentElementNameInUpperCase}");
}

if ($saveOrder){
	$saveOrderingUrl = "index.php?option=com_$componentNameInLowerCase&task={$itemListNameInLowerCase}.saveOrderAjax&tmpl=component";
	JHtml::_('sortablelist.sortable', "{$itemListNameInLowerCase}", "adminForm", strtolower($listDirn), $saveOrderingUrl);
}
