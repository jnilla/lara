...
<form action="<?php echo JRoute::_("index.php?option=com_$componentNameInLowerCase&view=$itemListNameInLowerCase"); ?>" method="post" name="adminForm" id="adminForm">
	<!-- Toolbar -->
	<?php echo (isset($this->toolbar)) ? $this->toolbar : ''; ?>
							...
							<td <?php echo $attribs; ?>>
								...
								<?php else : ?>
									...
									<?php if ($addLink && ($canEdit || $canEditOwn)) : ?>
										<?php // Add edit link ?>
										<a href="<?php echo JRoute::_("index.php?option=com_$componentNameInLowerCase&view=$itemNameInLowerCase&task=$itemNameInLowerCase.edit&id=".$item->id."&return=$return"); ?>"
